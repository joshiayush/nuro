 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "**Step 1:** Find $P(A \\cap B)$. A King IS a face card, so $A \\cap B$ = \"the card is a King\" = $A$.\n",
    "$$P(A \\cap B) = P(\\text{King}) = \\dfrac{4}{52} = \\dfrac{1}{13}$$\n",
    "\n",
    "**Step 2:** Find $P(B)$. There are 12 face cards (4 Jacks + 4 Queens + 4 Kings).\n",
    "$$P(B) = \\dfrac{12}{52} = \\dfrac{3}{13}$$\n",
    "\n",
    "**Step 3:** Apply the formula.\n",
    "$$P(A|B) = \\dfrac{P(A \\cap B)}{P(B)} = \\dfrac{1/13}{3/13} = \\dfrac{1}{3} \\approx 0.333$$\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "1. They **have** the disease AND the test correctly detects it\n",
    "2. They **don't have** the disease AND the test incorrectly flags them\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "$$\\binom{10}{7} = \\dfrac{10!}{7! \\cdot 3!} = \\dfrac{10 \\times 9 \\times 8}{3 \\times 2 \\times 1} = \\dfrac{720}{6} = 120$$\n",
    "\n",
    ...
    "$$P(X = 7) = 120 \\times 0.0078125 \\times 0.125 = 120 \\times 0.000977 = 0.1172$$\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "1. **Many natural phenomena follow it.** Heights of people, test scores, measurement errors, blood pressure readings — they all tend to form a bell-shaped curve.\n",
    "\n",
    "2. **The Central Limit Theorem.** When you average many random numbers together, the result tends to follow a Gaussian — regardless of what the original distribution looked like. This is one of the most remarkable results in all of mathematics.\n",
    "\n",
    "3. **Many ML algorithms assume it.** Linear regression assumes Gaussian errors. Gaussian Naive Bayes, Gaussian Mixture Models, and many other methods are built directly on this distribution.\n",
    "\n",
    "---\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "| Symbol | What It Is |\n",
    "|--------|------------|\n",
    "| $\\mathbf{x}$ | A vector of $d$ features (e.g., $[\\text{height}, \\text{weight}]$) |\n",
    "| $\\boldsymbol{\\mu}$ | The **mean vector** — the center of the distribution in $d$-dimensional space |\n",
    "| $\\mathbf{\\Sigma}$ | The **covariance matrix** — a $d \\times d$ matrix that captures how the features vary and relate |\n",
    "| $|\\mathbf{\\Sigma}|$ | The **determinant** of $\\mathbf{\\Sigma}$ (a scalar that measures the \"volume\" of the distribution) |\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "\n",
    "**Try it yourself first!** Use Bayes' theorem:\n",
    "$$P(D|F) = \\dfrac{P(F|D) \\cdot P(D)}{P(F)}$$\n",
    "\n",
